...
using ParamConversions = std::list<Fmi::CsvReader::row_type>;
...
struct CsvParams
{
 ...
 private:
  CsvParams &operator=(const CsvParams &) = delete;  // estet��n sijoitus opereraattori, est��
                                                     // varoituksen VC++ 2012 k��nt�j�ss�
};
