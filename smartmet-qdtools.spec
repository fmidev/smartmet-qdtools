...
Requires: zlib
#TestRequires: smartmet-library-macgyver-devel >= 25.9.4
#TestRequires: gcc-c++
...
* Wed Apr 16 2025 Andris Pavēnis <andris.pavenis@fmi.fi> 25.4.16-1.fmi
- nctoqd and others: use netCDF C++4 instead odf obsolete netcdfpp
