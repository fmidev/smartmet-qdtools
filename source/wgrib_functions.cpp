    ...
    FILE *file, long *pos, long *len_grib, unsigned char *buffer, unsigned int buf_len)
{
  ...
  while (!feof(file))
  {
    ...
    for (i = 0; i < len; i++)
    {
      ...
      {
        *pos = i + *pos;
        *len_grib = (buffer[i + 4] << 16) + (buffer[i + 5] << 8) + buffer[i + 6];
        return (buffer + i);
      }
    }
...
int read_grib(FILE *file, long pos, long len_grib, unsigned char *buffer)
{
  ...
  i = static_cast<int>(fread(buffer, sizeof(unsigned char), len_grib, file));
  return (i == len_grib);
}
...
extern struct ParmTable parm_table_fmi_opn[256];
...
static struct ParmTable *Parm_Table(unsigned char *pds)
{
  ...
  if (center == NMC && ptable <= 3)
  {
    ...
    return (def_ncep_table == opn) ? &parm_table_ncep_opn[0] : &parm_table_ncep_reanal[0];
  }
  ...
  if (center == 86 || center == 96)  // HKI eli FMI taulu kayttoon (86 on FMI center numero, mutta
                                     // vanhoissa HIRLAM datoissa saattaa olla nro 96)
    return parm_table_fmi_opn;
  else if ((ptable > 3 || (PDS_PARAM(pds)) > 127) && missing_count++ == 0)
  {
    fprintf(stderr,
                ...
                double scale)
{
  ...
  if (BDS_Harmonic(bds))
  {
    bits = bds + 15;
    /* fill in global mean */
    *flt++ = static_cast<float>(BDS_Harmonic_RefValue(bds));
    n -= 1;
  }
  else
  {
  ...
  if (n_bits <= 25)
  {
    ...
    if (bitmap)
    {
      for (i = 0; i < n; i++)
      {
        ...
        *flt++ = static_cast<float>(ref + scale * j);
      }
    }
    else
    {
      for (i = 0; i < n; i++)
      {
        ...
        t_bits -= n_bits;
        flt[i] = static_cast<float>((tbits >> t_bits) & jmask);
      }
      /* at least this vectorizes :) */
      for (i = 0; i < n; i++)
      {
        flt[i] = static_cast<float>(ref + scale * flt[i]);
      }
    }
  }
  else
...
int flt2ieee(float x, unsigned char *ieee)
{
  ...
  umant = static_cast<unsigned int>(mant * 16777216 + 0.5);
  if (umant >= 16777216)
  {
    umant = umant / 2;
    exp++;
...
int wrtieee(float *array, int n, int header, FILE *output)
{
  ...
  if (header)
  {
    ...
    for (i = 0; i < 4; i++)
    {
      h4[i] = static_cast<unsigned char>(l & 255);
      l >>= 8;
    }
    buff[nbuf++] = h4[3];
    buff[nbuf++] = h4[2];
...
void levels(int kpds6, int kpds7, int center)
{
  ...
  switch (kpds6)
  {
    ...
    case 201:
      ...
      break;
    case 204:
      printf("high trop freezing lvl");
      break;
    case 206:
      printf("grid-scale cld bot");
      break;
    case 207:
      printf("grid-scale cld top");
      break;
    case 209:
      printf("bndary-layer cld bot");
      break;
    case 210:
      printf("bndary-layer cld top");
      break;
    case 211:
      printf("bndary-layer cld layer");
      break;
    case 242:
      printf("convect-cld bot");
      break;
    case 243:
      printf("convect-cld top");
      break;
    case 244:
      printf("convect-cld layer");
      break;
    case 246:
      printf("max e-pot-temp lvl");
      break;
    case 247:
      printf("equilibrium lvl");
      break;
    case 248:
      printf("shallow convect-cld bot");
      break;
    case 249:
      printf("shallow convect-cld top");
      break;
    case 251:
      printf("deep convect-cld bot");
      break;
    case 252:
      printf("deep convect-cld top");
      break;
    ...
    case 100:
      ...
      break;
    case 101:
      printf("%d-%d mb", o11 * 10, o12 * 10);
      break;
    case 102:
      printf("MSL");
      break;
    case 103:
      printf("%d m above MSL", kpds7);
      break;
    case 104:
      printf("%d-%d m above msl", o11 * 100, o12 * 100);
      break;
    case 105:
      printf("%d m above gnd", kpds7);
      break;
    case 106:
      printf("%d-%d m above gnd", o11 * 100, o12 * 100);
      break;
    case 107:
      printf("sigma=%.4f", kpds7 / 10000.0);
      break;
    case 108:
      printf("sigma %.2f-%.2f", o11 / 100.0, o12 / 100.0);
      break;
    case 109:
      printf("hybrid lev %d", kpds7);
      break;
    case 110:
      printf("hybrid %d-%d", o11, o12);
      break;
    case 111:
      printf("%d cm down", kpds7);
      break;
    case 112:
      printf("%d-%d cm down", o11, o12);
      break;
    case 113:
      printf("%dK", kpds7);
      break;
    case 114:
      printf("%d-%dK", 475 - o11, 475 - o12);
      break;
    case 115:
      printf("%d mb above gnd", kpds7);
      break;
    case 116:
      printf("%d-%d mb above gnd", o11, o12);
      break;
    case 117:
      printf("%d pv units", INT2(o11, o12)); /* units are suspect */
      break;
    case 119:
      printf("%.5f (ETA level)", kpds7 / 10000.0);
      break;
    case 120:
      printf("%.2f-%.2f (ETA levels)", o11 / 100.0, o12 / 100.0);
      break;
    case 121:
      printf("%d-%d mb", 1100 - o11, 1100 - o12);
      break;
    case 125:
    ...
    case 128:
      ...
      break;
    case 141:
      printf("%d-%d mb", o11 * 10, 1100 - o12);
      break;
    case 160:
      printf("%d m below sea level", kpds7);
      break;
    default:
      break;
  }
...
static const char *units[] = {
    "min",       "hr",        "d",          "mon", "yr",  "decade", "normal", "century", "??", "??",
    " x3 hours", " x6 hours", " x12 hours", "??",  "??",  "??",     "??",     "??",      "??", "??",
    "??",        "??",        "??",         "??",  "??",  "??",     "??",     "??",      "??", "??",
    "??",        "??",        "??",         "??",  "??",  "??",     "??",     "??",      "??", "??",
    "??",        "??",        "??",         "??",  "??",  "??",     "??",     "??",      "??", "??",
    "??",        "??",        "??",         "??",  "??",  "??",     "??",     "??",      "??", "??",
...
void PDStimes(int time_range, int p1, int p2, int time_unit)
{
  ...
  if (time_unit >= 0 && static_cast<unsigned int>(time_unit) <= sizeof(units) / sizeof(char *))
  ...
  switch (time_range)
  {
    ...
    case 10:
      break;
    case 2:
      printf("valid %d-%d%s:", p1, p2, unit);
      break;
    case 3:
      printf("%d-%d%s ave:", p1, p2, unit);
      break;
    case 4:
      printf("%d-%d%s acc:", p1, p2, unit);
      break;
    case 5:
      printf("%d-%d%s diff:", p1, p2, unit);
      break;
    case 11:
      if (p1 > 0)
      {
...
struct ParmTable parm_table_nceptab_131[256] = {
    ...
    /* 232 */ {"WVINC", "water vapor added by precip assimilation [kg/m^2/s]"},
    /* 233 */ {"WCINC", "water condensate added by precip assimilaition [kg/m^2/s]"},
    /* 234 */ {"BGRUN", "Subsurface runoff (baseflow) [kg/m^2]"},
    /* 235 */ {"SSRUN", "Surface runoff (non-infiltrating) [kg/m^2]"},
    /* 236 */ {"var236", "undefined"},
    /* 237 */ {"WVCONV", "Water vapor flux convergence (vertical int) [kg/m^2/s]"},
    /* 238 */ {"SNOWC", "Snow cover [%]"},
    /* 239 */ {"SNOT", "Snow temperature [K]"},
    /* 240 */ {"POROS", "Soil porosity [fraction]"},
    /* 241 */ {"WCCONV", "Water condensate flux convergence (vertical int) [kg/m^2/s]"},
    /* 242 */ {"WVUFLX", "Water vapor zonal flux (vertical int)[kg/m/s]"},
    /* 243 */ {"WVVFLX", "Water vapor meridional flux (vertical int) [kg/m/s]"},
    /* 244 */ {"WCUFLX", "Water condensate zonal flux (vertical int) [kg/m/s]"},
    /* 245 */ {"WCVFLX", "Water condensate meridional flux (vertical int) [kg/m/s]"},
             ...
             long *theUsedOutputGridRowLength)
{
  ...
  theVariableLengthRows.clear();  // tyhjennetään varmuuden vuoksi
  ...
  *nxny = ix * iy;
  ...
  if (GDS_Gaussian(gds) || GDS_LatLon(gds))
  {
    if (ix == 65535)
    {
      *nx = -1;
      ...
      for (i = 0; i < iy; i++)
      {
        long rowLength = gds[pl + i * 2] * 256 + gds[pl + i * 2 + 1];
        isum += rowLength;
        theVariableLengthRows.push_back(rowLength);
      }
      *nxny = isum;
      *theUsedOutputGridRowLength =
          *(std::max_element(theVariableLengthRows.begin(), theVariableLengthRows.end()));
    }
    return 0;
  }
  ...
  if (GDS_Harmonic(gds))
  {
    ...
    *nx = *nxny = (8 * (BDS_LEN(bds) - 15) - BDS_UnusedBits(bds)) / BDS_NumBits(bds) + 1;
...
static const char *scan_mode[8] = {"EW/NS",
                                   "NS/EW",
...
void GDS_winds(unsigned char *gds, int verbose)
{
  ...
  if (verbose == 1)
  {
    ...
    {
      if (mode & 8)
        printf("winds in grid direction:");
      else
        printf("winds are N/S:");
    }
  }
  else if (verbose == 2)
  {
...
int setup_user_table(int center, int subcenter, int ptable)
{
  ...
  for (;;)
  {
    ...
    if ((center == -1 || center == user_center) &&
        (subcenter == -1 || subcenter == user_subcenter) && (ptable == -1 || ptable == user_ptable))
      break;
  }
  ...
  if (parm_table_user[i].name != nullptr)
  {
    for (i = 0; i < 256; i++)
    {
      free(const_cast<void *>(reinterpret_cast<const void *>(parm_table_user[i].name)));
      free(const_cast<void *>(reinterpret_cast<const void *>(parm_table_user[i].comment)));
    }
  }
  ...
  for (;;)
  {
    ...
    strcpy(const_cast<char *>(parm_table_user[i].name), line + c0 + 1);
    strcpy(const_cast<char *>(parm_table_user[i].comment), line + c1 + 1);
  }
  ...
  for (i = 0; i < 255; i++)
  {
    if (parm_table_user[i].name == nullptr)
    {
      ...
      strcpy(const_cast<char *>(parm_table_user[i].comment), "undefined");
    }
  }
  status = filled;
  return 1;
...
void ensemble(unsigned char *pds, int mode)
{
  ...
  else if (PDS_Center(pds) == NMC && pdslen >= 45 && pds[40] == 1)
  {
    ...
    else if (pds[41] == 2 || pds[41] == 3)
    {
      ...
      {
        printf("ens_perturbation=%c%d ", pds[41] == 3 ? '+' : '-', pds[42]);
      }
    }
    ...
    if ((PDS_PARAM(pds) == 191 || PDS_PARAM(pds) == 192) && pdslen >= 47)
    {
      ...
      {
        printf("prob(%f<%s<%f)%c", ibm2flt(pds + 47), k5toa(pds), ibm2flt(pds + 51), char_end);
      }
      PDS_PARAM(pds) = ctmp;
    }
  }
...
struct ParmTable parm_table_dwd_002[256] = {
    /* 0 */ {"var0", "undefined"},
    /* 1 */ {"PS", "pressure [Pa]"},
    /* 2 */ {"PS_msl", "pressure reduced to MSL [Pa]"},
    ...
    /* 31 */ {"wind dir.", "wind direction [degree true]"},
    /* 32 */ {"wind speed", "wind speed [m/s]"},
    ...
    /* 40 */ {"vert. vel.", "vertical velocity [m/s]"},
    ...
    /* 91 */ {"ice cover", "ice cover (1=ice, 0=no ice) [proportion]"},
    /* 92 */ {"ice thickn", "ice thickness [m]"},
...
struct ParmTable parm_table_dwd_201[256] = {
    ...
    /* 127 */ {"DQL_GSP", "tendency of total water, grid-scale condensation [s**(-1)]"},
    ...
    /* 195 */ {"var195", "undefined"},
    /* 196 */ {"var196", "undefined"},
    /* 197 */ {"so_temp", "temperature of soil layers [K]"},
    /* 198 */ {"so_wa+ice", "water + ice content of soil layers [kg/(m**2)]"},
    /* 199 */ {"so_ice", "ice content of soil layers [kg/(m**2)]"},
...
struct ParmTable parm_table_dwd_202[256] = {
    ...
    /* 180 */ {"O3", "specific ozone content [kg/kg]"},
    /* 181 */ {"var181", "undefined"},
    /* 182 */ {"var182", "undefined"},
    /* 183 */ {"var183", "undefined"},
    /* 184 */ {"var184", "undefined"},
    ...
    /* 249 */ {"h UV-IndMx", "time (Zeit) of UV-Index-Maximum [h UTC]"},
    /* 250 */ {"var250", "undefined"},
    /* 251 */ {"var251", "undefined"},
    /* 252 */ {"var252", "undefined"},
    /* 253 */ {"var253", "undefined"},
...
/*
 * parameter table for FMI (Finnish Met Inst.Helsinki)
 * center = 86, subcenter = ? parameter table = 1
 * updated 8/2003
 */

struct ParmTable parm_table_fmi_opn[256] = {
    /* 0 */ {"varxxx", "undefined"},
    /* 1 */ {"pressure", "Pa"},
    /* 2 */ {"varxxx", "undefined"},
    /* 3 */ {"varxxx", "undefined"},
    ...
    /* 31 */ {"varxxx", "undefined"},
    /* 32 */ {"varxxx", "undefined"},
    /* 33 */ {"wind: x-component", "m/s"},
    /* 34 */ {"wind: y-component", "m/s"},
    /* 35 */ {"varxxx", "undefined"},
    /* 36 */ {"varxxx", "undefined"},
    /* 37 */ {"varxxx", "undefined"},
    /* 38 */ {"varxxx", "undefined"},
    /* 39 */ {"pressure coordinate vertical velocity", "Pa/s"},
    /* 40 */ {"varxxx", "undefined"},
    /* 41 */ {"varxxx", "undefined"},
    /* 42 */ {"varxxx", "undefined"},
    /* 43 */ {"varxxx", "undefined"},
    ...
    /* 62 */ {"grid-scale precipitation", "kg/m2"},
    /* 63 */ {"sub grid-scale precipitation", "kg/m2"},
    /* 64 */ {"varxxx", "undefined"},
    /* 65 */ {"total snowfall", "kg/m2"},
    /* 66 */ {"water equivalent of snowpack", "m"},
    /* 67 */ {"depth of the boundary layer", "m"},
    /* 68 */ {"varxxx", "undefined"},
    /* 69 */ {"varxxx", "undefined"},
    /* 70 */ {"varxxx", "undefined"},
    /* 71 */ {"total cloud cover", "fraction"},
    /* 72 */ {"varxxx", "undefined"},
    /* 73 */ {"low level cloud cover", "fraction"},
    /* 74 */ {"medium level cloud cover", "fraction"},
    /* 75 */ {"high level cloud cover", "fraction"},
    /* 76 */ {"specific cloud condensate", "kg/kg"},
    /* 77 */ {"varxxx", "undefined"},
    /* 78 */ {"sub grid-scale snowfall", "kg/m2"},
    /* 79 */ {"grid-scale snowfall", "kg/m2"},
    /* 80 */ {"varxxx", "undefined"},
    /* 81 */ {"fraction of land", "fraction"},
    /* 82 */ {"varxxx", "undefined"},
    /* 83 */ {"roughness length", "m"},
    /* 84 */ {"albedo", "m"},
    /* 85 */ {"varxxx", "undefined"},
    /* 86 */ {"water content", "m3/m3"},
    /* 87 */ {"varxxx", "undefined"},
    /* 88 */ {"varxxx", "undefined"},
    /* 89 */ {"varxxx", "undefined"},
    /* 90 */ {"varxxx", "undefined"},
    /* 91 */ {"ice concentration", "0..1"},
    /* 92 */ {"varxxx", "undefined"},
    /* 93 */ {"varxxx", "undefined"},
    /* 94 */ {"varxxx", "undefined"},
    /* 95 */ {"varxxx", "undefined"},
    ...
    /* 98 */ {"varxxx", "undefined"},
    /* 99 */ {"varxxx", "undefined"},
    /* 100 */ {"varxxx", "undefined"},
    /* 101 */ {"varxxx", "undefined"},
    /* 102 */ {"varxxx", "undefined"},
    /* 103 */ {"varxxx", "undefined"},
    /* 104 */ {"varxxx", "undefined"},
    /* 105 */ {"varxxx", "undefined"},
    /* 106 */ {"varxxx", "undefined"},
    /* 107 */ {"varxxx", "undefined"},
    /* 108 */ {"varxxx", "undefined"},
    /* 109 */ {"varxxx", "undefined"},
    /* 110 */ {"varxxx", "undefined"},
    /* 111 */ {"net short-wave radiation", "J/m2"},
    /* 112 */ {"net long-wave radiation", "J/m2"},
    /* 113 */ {"varxxx", "undefined"},
    /* 114 */ {"varxxx", "undefined"},
    /* 115 */ {"downwelling long-wave radiation", "J/m2"},
    /* 116 */ {"varxxx", "undefined"},
    /* 117 */ {"downwelling (global) short-wave radiation", "J/m2"},
    /* 118 */ {"varxxx", "undefined"},
    /* 119 */ {"varxxx", "undefined"},
    /* 120 */ {"varxxx", "undefined"},
    /* 121 */ {"latent heat flux", "J/m2"},
    /* 122 */ {"sensible heat flux", "J/m2"},
    /* 123 */ {"varxxx", "undefined"},
    /* 124 */ {"turbulent momentum flux (u-component)", "Pa s"},
    /* 125 */ {"turbulent momentum flux (v-component)", "Pa s"},
    /* 126 */ {"varxxx", "undefined"},
    /* 127 */ {"varxxx", "undefined"},
    /* 128 */ {"scalar momentum flux", "Pa"},
    /* 129 */ {"varxxx", "undefined"},
    /* 130 */ {"varxxx", "undefined"},
    /* 131 */ {"varxxx", "undefined"},
    /* 132 */ {"varxxx", "undefined"},
    /* 133 */ {"varxxx", "undefined"},
    /* 134 */ {"varxxx", "undefined"},
    /* 135 */ {"varxxx", "undefined"},
    /* 136 */ {"varxxx", "undefined"},
    /* 137 */ {"varxxx", "undefined"},
    /* 138 */ {"varxxx", "undefined"},
    /* 139 */ {"varxxx", "undefined"},
    /* 140 */ {"temperature over land", "K"},
    /* 141 */ {"specific humidity over land", "kg/kg"},
    /* 142 */ {"varxxx", "undefined"},
    /* 143 */ {"varxxx", "undefined"},
    /* 144 */ {"varxxx", "undefined"},
    /* 145 */ {"varxxx", "undefined"},
    /* 146 */ {"varxxx", "undefined"},
    /* 147 */ {"varxxx", "undefined"},
    /* 148 */ {"varxxx", "undefined"},
    /* 149 */ {"varxxx", "undefined"},
    /* 150 */ {"varxxx", "undefined"},
    /* 151 */ {"varxxx", "undefined"},
    /* 152 */ {"varxxx", "undefined"},
    /* 153 */ {"varxxx", "undefined"},
    /* 154 */ {"varxxx", "undefined"},
    /* 155 */ {"varxxx", "undefined"},
    /* 156 */ {"varxxx", "undefined"},
    /* 157 */ {"varxxx", "undefined"},
    /* 158 */ {"varxxx", "undefined"},
    /* 159 */ {"varxxx", "undefined"},
    /* 160 */ {"varxxx", "undefined"},
    /* 161 */ {"varxxx", "undefined"},
    /* 162 */ {"varxxx", "undefined"},
    /* 163 */ {"varxxx", "undefined"},
    /* 164 */ {"varxxx", "undefined"},
    /* 165 */ {"varxxx", "undefined"},
    /* 166 */ {"varxxx", "undefined"},
    /* 167 */ {"varxxx", "undefined"},
    /* 168 */ {"varxxx", "undefined"},
    /* 169 */ {"varxxx", "undefined"},
    /* 170 */ {"varxxx", "undefined"},
    /* 171 */ {"varxxx", "undefined"},
    /* 172 */ {"varxxx", "undefined"},
    /* 173 */ {"varxxx", "undefined"},
    /* 174 */ {"varxxx", "undefined"},
    /* 175 */ {"varxxx", "undefined"},
    /* 176 */ {"varxxx", "undefined"},
    /* 177 */ {"varxxx", "undefined"},
    /* 178 */ {"varxxx", "undefined"},
    /* 179 */ {"varxxx", "undefined"},
    /* 180 */ {"varxxx", "undefined"},
    /* 181 */ {"varxxx", "undefined"},
    /* 182 */ {"varxxx", "undefined"},
    /* 183 */ {"varxxx", "undefined"},
    /* 184 */ {"varxxx", "undefined"},
    /* 185 */ {"varxxx", "undefined"},
    /* 186 */ {"varxxx", "undefined"},
    /* 187 */ {"varxxx", "undefined"},
    /* 188 */ {"varxxx", "undefined"},
    /* 189 */ {"varxxx", "undefined"},
    /* 190 */ {"varxxx", "undefined"},
    /* 191 */ {"varxxx", "undefined"},
    /* 192 */ {"canopy water", "kg/m2"},
    /* 193 */ {"surface frozen soil water content", "m3/m3"},
    /* 194 */ {"varxxx", "undefined"},
    /* 195 */ {"soil type", ""},
    /* 196 */ {"vegetation type", ""},
    /* 197 */ {"fraction of forest", "0..1"},
    /* 198 */ {"varxxx", "undefined"},
    /* 199 */ {"varxxx", "undefined"},
    /* 200 */ {"kinetic energy of turbulence", "m2/s2"},
    /* 201 */ {"free turbulence parameter", ""},
    /* 202 */ {"varxxx", "undefined"},
    /* 203 */ {"varxxx", "undefined"},
    /* 204 */ {"varxxx", "undefined"},
    /* 205 */ {"varxxx", "undefined"},
    /* 206 */ {"varxxx", "undefined"},
    /* 207 */ {"varxxx", "undefined"},
    /* 208 */ {"varxxx", "undefined"},
    /* 209 */ {"varxxx", "undefined"},
    /* 210 */ {"varxxx", "undefined"},
    /* 211 */ {"varxxx", "undefined"},
    /* 212 */ {"varxxx", "undefined"},
    /* 213 */ {"varxxx", "undefined"},
    /* 214 */ {"varxxx", "undefined"},
    /* 215 */ {"varxxx", "undefined"},
    /* 216 */ {"varxxx", "undefined"},
    /* 217 */ {"varxxx", "undefined"},
    /* 218 */ {"varxxx", "undefined"},
    /* 219 */ {"varxxx", "undefined"},
    /* 220 */ {"varxxx", "undefined"},
    /* 221 */ {"varxxx", "undefined"},
    /* 222 */ {"varxxx", "undefined"},
    /* 223 */ {"varxxx", "undefined"},
    /* 224 */ {"varxxx", "undefined"},
    /* 225 */ {"varxxx", "undefined"},
    /* 226 */ {"varxxx", "undefined"},
    /* 227 */ {"varxxx", "undefined"},
    /* 228 */ {"varxxx", "undefined"},
    /* 229 */ {"varxxx", "undefined"},
    /* 230 */ {"varxxx", "undefined"},
    /* 231 */ {"varxxx", "undefined"},
    /* 232 */ {"varxxx", "undefined"},
    /* 233 */ {"varxxx", "undefined"},
    /* 234 */ {"varxxx", "undefined"},
    /* 235 */ {"varxxx", "undefined"},
    /* 236 */ {"varxxx", "undefined"},
    /* 237 */ {"varxxx", "undefined"},
    /* 238 */ {"varxxx", "undefined"},
    /* 239 */ {"varxxx", "undefined"},
    /* 240 */ {"varxxx", "undefined"},
    /* 241 */ {"varxxx", "undefined"},
    /* 242 */ {"varxxx", "undefined"},
    /* 243 */ {"varxxx", "undefined"},
    /* 244 */ {"varxxx", "undefined"},
    /* 245 */ {"varxxx", "undefined"},
    /* 246 */ {"varxxx", "undefined"},
    /* 247 */ {"varxxx", "undefined"},
    /* 248 */ {"varxxx", "undefined"},
    /* 249 */ {"varxxx", "undefined"},
    /* 250 */ {"varxxx", "undefined"},
    /* 251 */ {"varxxx", "undefined"},
    /* 252 */ {"varxxx", "undefined"},
    /* 253 */ {"varxxx", "undefined"},
    /* 254 */ {"varxxx", "undefined"},
    /* 255 */ {"var255", "undefined"},
};
